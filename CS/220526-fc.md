...
- 네트워크의 유형
  ...
  <br />
  <img src="./img/internet-schema.png" width="500px"><br />
...
- 네트워크 토롤로지
  ...
  <img src="./img/network-topology-1.png" width="450px">
  <img src="./img/network-topology-2.png" width="450px">

### 네트워크의 계층별 역할
- OSI 7 Layer 와 TCP/IP의 관계
  <img src="./img/osi-7-vs-tcpip.png" width="500px">  

- 큰 그림  
  <img src="./img/end-to-end.png" width="500px">
...
- 물리 계층(Physical layer)
  ...
  - 하드웨어
  <img src="./img/osi-physical-layer-hardward.png" width="500px">
...
- 데이터 링크 계층(Data link layer)
  ...
  - 대충 정리  
    ...
    <img src="./img/osi-data-layer-frame.png" width="500px">
  ...
  - 데이터 링크 계층에서 사용하는 주요 프로토콜  
    ...
    <img src="./img/osi-data-layer.png" width="500px">
...
- 데이터 링크 계층의 전달 요소
  - 물리주소의 데이터 전달 과정
    ...
    <img src="./img/osi-data-layer-frame2.png" width="400px">
...
- 네트워크 계층(Network layer)
  ...
  - 기능
    ...
    <img src="./img/osi-network-layer-simple.png" width="500px">
  ...
  - 상세 - 발신지(Source) 대 목적지(Destination) 전달
    ...
    <img src="./img/osi-network-layer.png" width="500px">
    ...
    - 전달은 상위 계층(전송 계층)에서 온 데이터를 쪼개서 패킷화 하고  
      그 패킷을 전달한다.
    <img src="./img/osi-network-layer-example.png" width="400px">
...
- 전송 계층(Transport layer)  
  - 개요
    ...
    <img src="./img/osi-transport-layer-simple.png" width="500px">
  ...
  - 전달
    메시지의 프로세스 대 프로세스 전달  
    <img src="./img/osi-transport-layer.png" width="500px">
  ...
  - 예시  
    ...
    <img src="./img/osi-transport-layer-example.png" width="500px">
...
- 응용 계층(Application layer)
  ...
  <img src="./img/osi-application-layer-simple.png" width="500px">
...
- 각 계층과 프로토콜의 비교
  <img src="./img/osi-layer-by-protocol.png" width="500px">

- Application 과 조합되는 프로토콜
  <img src="./img/application-by-protocol.png" width="400px">
